...
<h3>Applicant Sign Up</h3>
                <form name="f1" method="post" action="ApplicantServlet" onsubmit="return validate();">
                    ...
                    <input type="text" id="mname" name="mname" class="required input_field" />
                    <div class="clear"></div>
