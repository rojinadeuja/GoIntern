<%-- 
    Document   : signin
    Created on : Jan 17, 2017, 10:32:58 AM
    Author     : Roseenah
--%>
...
<h1> Sign Up Categories </h1>
<br>
<br>
<div class="right">
<h2> Applicant Sign Up </h2>
<p> Register as an appicant if you are a student or graduate in technology looking to find internship to kick-start your career. </p>
<a href="signup_applicant.jsp" class="more">Sign Up Here</a>
<br>
<br>
<h2> Company Sign Up </h2>
<p> Register as a company if you are an organization looking for interns to join your team. </p>
<a href="signup_company.jsp" class="more">Sign Up Here</a>
 </div>       
	...
	<div id="tooplate_footer">
    	<div class="col_4">
           ...
           <ul class="nobullet bottom_list">
            	<li><a href="index.jsp">Home</a></li>
                <li><a href="gallery.jsp">Get the App</a></li>
                <li><a href="blog.jsp">Sign Up</a></li>
                <li><a href="about.jsp">About</a></li>
