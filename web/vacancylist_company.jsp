...
<div id="tooplate_header">
  ...
  <%
    ...
    String usernam= verifiedCUser.getCUserName(); //yomari
    //out.println(usernam);
          %>       
   <%
...
String sql ="SELECT * FROM vacancylist,companylist,company WHERE vacancylist.cid=companylist.clid AND vacancylist.cid=company.uid";
...
<div id="tooplate_content" class="left">
        	<div class="post">
	            <h2><a href="#"><%=resultSet.getString("title") %></a></h2>
                <div class="post_meta">
    ...
    <span class="date"><%=resultSet.getString("expirydate") %></span>
                                ...
                                <a class="more" href=<%= "\"fullpost_company.jsp?Id=" + resultSet.getInt("vid") + "\"" %>>More</a>
                               
                                <%
                       String usernam1= resultSet.getString("company.cname");
                     // out.println(usernam);
                      //out.println(usernam1);
                         if (usernam1.equals(usernam))
                           { %> <form action="VacancyServlet">
                     <input type="hidden" id="id" name="id" value="<%=resultSet.getString("vacancylist.vid")%>" />
                     <br> <input type="submit" value="Delete" class="search_2" />
                      </form>
                              <%}%>                    
