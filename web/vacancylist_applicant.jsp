...
String sql ="SELECT * FROM vacancylist,companylist WHERE vacancylist.cid=companylist.clid";
...
<div id="tooplate_content" class="left">
    ...
    <span class="date"><%=resultSet.getString("expirydate") %></span>
                                ...
                                <a class="more" href=<%= "\"fullpost.jsp?Id=" + resultSet.getInt("vid") + "\"" %>>More</a>
                             <%
