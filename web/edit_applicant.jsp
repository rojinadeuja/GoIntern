...
%>
<form method="post" action="EditApplicantServlet">
     <input type="hidden" id="Id" name="Id" value="<%=resultSet.getString("alid")%>" />
<table class="altrowstable" id="alternatecolor" width="700">
 <tbody align="left">           
     <tr>
            <th scope="row">First Name</th>
            <td><input type="text" id="fname" value="<%=resultSet.getString("fname")%>" name="fname"></td>
        </tr>
        <tr>
            <th scope="row">Middle Name</th>
            <td><input type="text" id="mname" name="mname" value="<%=resultSet.getString("mname")%>"></td>
        </tr>
        <tr>
            <th scope="row">Last Name</th>
            <td><input type="text" id="lname" name="lname" value="<%=resultSet.getString("lname")%>"></td>
        ...
        <tr>
            <th scope="row">Gender</th>
             <td><input type="text" id="gender" name="gender" value="<%=resultSet.getString("gender")%>"></td>
        ...
        <tr>
          ...
          <td><input type="text" id="email" name="email" value="<%=resultSet.getString("email")%>"></td>
           ...
           <input type="submit" name="Submit" value="Submit" class="search_2 float_center" />
</form>
          <div id="home_about">
