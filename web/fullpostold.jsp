...
<div id="tooplate_header">
    ...
    <div id="tooplate_menu" class="ddsmoothmenu">
          ...
          <li><a href="signup.jsp" class="selected">Sign Up</a>
                <ul>
    ...
    <div id="tooplate_main">
    	...
    	<div id="tooplate_content" class="left">
        	<div class="post">
	            <h2><a href="fullpost.jsp">Lorem Ipsum Dolor Sit Amet</a></h2>
                ...
                <div class="post_meta">
                    ...
                    <span class="tag"><a href="#">HTML</a>, <a href="#">Template</a></span>
                    <span class="comment">10</span>
				</div>
                <p> Mauris pulvinar nisi ut mi placerat interdum. Sed commodo, lectus sit amet fermentum posuereligula orci venenatis augue, id porta magna ipsum id nunc. Lorem ipsum dolor sit amet, <a href="#">consectetur</a> adipiscing elit. Etiam nec turpis bibendum massa dapibus dictum. </p>
              <p>Donec eu odio sapien. Donec tincidunt eleifend mauris, ac volutpat leo tincidunt a. Aenean vel vehicula augue. Vestibulum lectus sem, porttitor non molestie quis, pulvinar nec nulla. Maecenas id orci vitae lectus fermentum posuere. <a href="#">Phasellus</a> lacinia eleifend elit, eu mollis erat consectetur et. Integer semper sollicitudin quam a ornare. Nam venenatis nibh ac sem faucibus et imperdiet magna laoreet.</p>
<p align="justify">Vestibulum at lorem ac lectus rhoncus aliquet eget ac mauris. Proin nec nunc magna, eu blandit massa. Sed elementum nisi ut quam vehicula eu egestas nisi varius. <a href="#">Aenean semper</a> convallis mi eu congue. In vel neque orci.</p>
            ...
            <li>
                <div class="comment_box">
                    ...
                    <div class="comment_content">
                        <div class="comment_meta"><strong><a href="#">John Smith</a></strong> April 24, 2048 11:38 am</div>
                        <p>Sed hendrerit molestie ante, sit amet porta leo porta ut. Praesent adipiscing turpis at nisl dapibus vehicula. In hac habitasse platea dictumst. Vestibulum enim turpis, faucibus sed varius nec, tincidunt a leo. </p>
                ...
                <ul>
                    <li class="depth_2">
                        <div class="comment_box">
                            <img src="images/avator.jpg" alt="" class="img_fl img_border" />
                            <div class="comment_content">
                            <div class="comment_meta"><strong><a href="#">Joseph</a></strong> May 2, 2048 8:22 am</div>
                    ...
                    <ul>
                        <li class="depth_3">
                            <div class="comment_box">
                                <img src="images/avator.jpg" alt="" class="img_fl img_border" />
                                <div class="comment_content">
                                <div class="comment_meta"><strong><a href="#">Adam</a></strong> May 5, 2048 9:07 am</div>
                                <p>Etiam vulputate semper lorem quis gravida. Donec nec aliquam ipsum. Nulla feugiat feugiat erat et consequat. </p>
                                <a href="#" class="more">Reply</a>
                                </div>
                                <div class="clear"></div>
                            </div>
            ...
            <li>
                <div class="comment_box">
                    <img src="images/avator.jpg" alt="" class="img_fl img_border" />
                    <div class="comment_content">
                      <div class="comment_meta"><strong><a href="#">Simon</a></strong> April 12, 2048 2:51 am</div>
                        <p>Nunc vitae luctus ligula. In hac habitasse platea dictumst. Vestibulum enim turpis, faucibus sed varius nec, tincidunt a leo. </p>
                        <a href="#" class="more">Reply</a>
                    </div>
                    <div class="clear"></div>
                </div>
            ...
            <li>
                <div class="comment_box">
                    <img src="images/avator.jpg" alt="" class="img_fl img_border" />
                    <div class="comment_content">
                        <div class="comment_meta"><strong><a href="#">Rose</a></strong> April 9, 2048 11:08 am</div>
                        <p>Sed at risus dui. Ut imperdiet libero at mauris vestibulum tempor. In hac habitasse platea dictumst. Vestibulum enim turpis, faucibus sed varius nec, tincidunt a leo. </p>
                        <a href="#" class="more">Reply</a>
                    </div>
                    <div class="clear"></div>
                </div>
