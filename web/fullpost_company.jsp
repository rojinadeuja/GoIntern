    	...
    	<div id="tooplate_content" class="left">
        	<div class="post">
                    ...
                    <br><p><%=resultSet.getString("detail") %></p>
                                ...
                                <a class="more" href="fullpost.jsp">Delete</a>
                </div>
        <div class="post">
                ...
                <div class="post_meta">
                    ...
                    <a class="moree" href="myaccount_company.jsp">Edit</a>
        </div>
<% 
}
 ...
 <ol class="comment_list">
            <li>
                <div class="comment_box">
                    ...
                    <div class="comment_content">
                        <div class="comment_meta"><strong><a href="#">tina</a></strong></div> 
                        <p>I want to apply.</p>
            ...
            <li>
                <div class="comment_box">
                    <img src="images/avator.jpg" alt="" class="img_fl img_border" />
                    <div class="comment_content">
                        <div class="comment_meta"><strong><a href="#">jack</a></strong></div> 
                        <p>Does not pay much. Not recommended,</p>
